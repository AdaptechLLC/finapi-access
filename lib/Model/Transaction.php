...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_transaction_code'] = $data['bank_transaction_code'] ?? null;
        ...
        $this->container['paypal_data'] = $data['paypal_data'] ?? null;
     ...
     * Sets paypal_data
     *
     * @param PaypalTransactionData $paypal_data <strong>Type:</strong> PaypalTransactionData<br/> Additional, PayPal-specific transaction data.
     *
     * @return self
     */
