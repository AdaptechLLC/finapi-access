...
class BankInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_money_transfer_supported'] = $data['is_money_transfer_supported'] ?? null;
     ...
     *
     * @param bool $is_money_transfer_supported Whether this interface has the general capability to do money transfers.<br/><br/>Note: It still depends on the specifics of an account whether the account supports money transfer. In general, you should prefer the field AccountInterface.capabilities to determine what is possible for a specific account. This field here is meant to be used mainly for when you want to do standalone money transfers (finAPI Payment product), i.e. when you do not plan to import an account and thus will not have the information about the account's capabilities.
     *
     * @return self
     */
