...
class DeleteConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets local
     *
     * @param DeleteConsentResult $local <strong>Type:</strong> DeleteConsentResult<br/> Result of deleting a consent stored in the finAPI database (local):<br/><br/>&bull; <code>DELETED</code> - when there was a stored consent and it was deleted.<br/>&bull; <code>NOT_EXIST</code> - if there is no stored consent.<br/>
     *
     * @return self
     */
