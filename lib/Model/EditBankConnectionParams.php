...
class EditBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $default_two_step_procedure_id NOTE: In the future, this field will work only in combination with the 'interface' field.<br/><br/>New default two-step-procedure. Must match the 'procedureId' of one of the procedures that are listed in the bank connection. If you do not want to change this field let it remain unset. If you want to clear the current default two-step-procedure, set the field's value to an empty string (\"\").<br/><br/><strong>NOTE:</strong> We currently do not offer this functionality for Web Form 2.0 customers yet.
     *
     * @return self
     */
