...
class TwoStepProcedure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['procedure_id'] = $data['procedure_id'] ?? null;
        $this->container['procedure_name'] = $data['procedure_name'] ?? null;
        $this->container['procedure_challenge_type'] = $data['procedure_challenge_type'] ?? null;
        $this->container['implicit_execute'] = $data['implicit_execute'] ?? null;
    }
