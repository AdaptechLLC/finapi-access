...
class RequestSepaMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['clearing_account_id'] = $data['clearing_account_id'] ?? null;
        ...
        $this->container['additional_money_transfers'] = $data['additional_money_transfers'] ?? null;
     ...
     * Sets execution_date
     *
     * @param string|null $execution_date Execution date for the money transfer(s), in the format 'YYYY-MM-DD'. If not specified, then the current date will be used.
     *
     * @return self
     */
