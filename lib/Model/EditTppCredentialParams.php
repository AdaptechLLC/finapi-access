...
class EditTppCredentialParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['tpp_authentication_group_id'] = $data['tpp_authentication_group_id'] ?? null;
        $this->container['label'] = $data['label'] ?? null;
        $this->container['tpp_client_id'] = $data['tpp_client_id'] ?? null;
        $this->container['tpp_client_secret'] = $data['tpp_client_secret'] ?? null;
        $this->container['tpp_api_key'] = $data['tpp_api_key'] ?? null;
        $this->container['tpp_name'] = $data['tpp_name'] ?? null;
        $this->container['valid_from_date'] = $data['valid_from_date'] ?? null;
     ...
     *
     * @param string|null $valid_from_date Credentials \"valid from\" date in the format 'YYYY-MM-DD'. Default is today's date
     *
     * @return self
     */
     ...
     *
     * @param string|null $valid_until_date Credentials \"valid until\" date in the format 'YYYY-MM-DD'. Default is null which means \"indefinite\" (no limit)
     *
     * @return self
     */
