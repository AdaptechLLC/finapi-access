...
class TppCertificateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ca_public_key'] = $data['ca_public_key'] ?? null;
     ...
     *
     * @param string|null $valid_from_date Start day of the certificate's validity, in the format 'YYYY-MM-DD'. Default is the passed certificate validFrom date
     *
     * @return self
     */
     ...
     *
     * @param string|null $valid_until_date Expiration day of the certificate's validity, in the format 'YYYY-MM-DD'. Default is the passed certificate validUntil date
     *
     * @return self
     */
