...
class ClientConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param WebFormMode $ais_web_form_mode <strong>Type:</strong> WebFormMode<br/> Indicates whether the client is using the finAPI webform for Account Initiation Services.<br/>Possible values: <br/>&bull; <code>DISABLED</code> - No web form is triggered<br/>&bull; <code>INTERNAL</code> - End users will be directed to the <a href='https://finapi.zendesk.com/hc/en-us/articles/360002596391-finAPI-PSD2-Web-Form' target='_blank'>classical web form</a> implementation for AIS services.<br/>&bull; <code>EXTERNAL</code> - End users will be directed to the <a href='https://finapi.jira.com/wiki/spaces/FWFPD/overview'  target='_blank'>new web form</a> implementation for AIS services.
     *
     * @return self
     */
     ...
     *
     * @param WebFormMode $pis_web_form_mode <strong>Type:</strong> WebFormMode<br/> Indicates whether the client is using the finAPI webform for Standard Payment Initiation Services (account import mandatorily preceding payment initiation).<br/>Possible values: <br/>&bull; <code>DISABLED</code> - No web form is triggered<br/>&bull; <code>INTERNAL</code> - End users will be directed to the <a href='https://finapi.zendesk.com/hc/en-us/articles/360002596391-finAPI-PSD2-Web-Form' target='_blank'>classical web form</a> implementation for AIS services.<br/>&bull; <code>EXTERNAL</code> - End users will be directed to the <a href='https://finapi.jira.com/wiki/spaces/FWFPD/overview'  target='_blank'>new web form</a> implementation for AIS services.
     *
     * @return self
     */
     ...
     *
     * @param WebFormMode $pis_standalone_web_form_mode <strong>Type:</strong> WebFormMode<br/> Indicates whether the client is using the finAPI webform for Standalone Payment Initiation Services (Payment initiation without account import).<br/>Possible values: <br/>&bull; <code>DISABLED</code> - No web form is triggered<br/>&bull; <code>INTERNAL</code> - End users will be directed to the <a href='https://finapi.zendesk.com/hc/en-us/articles/360002596391-finAPI-PSD2-Web-Form' target='_blank'>classical web form</a> implementation for AIS services.<br/>&bull; <code>EXTERNAL</code> - End users will be directed to the <a href='https://finapi.jira.com/wiki/spaces/FWFPD/overview'  target='_blank'>new web form</a> implementation for AIS services.
     *
     * @return self
     */
