...
class Bank implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blz'] = $data['blz'] ?? null;
        $this->container['location'] = $data['location'] ?? null;
        $this->container['city'] = $data['city'] ?? null;
        $this->container['is_test_bank'] = $data['is_test_bank'] ?? null;
        $this->container['popularity'] = $data['popularity'] ?? null;
        $this->container['interfaces'] = $data['interfaces'] ?? null;
        $this->container['bank_group'] = $data['bank_group'] ?? null;
        $this->container['is_beta'] = $data['is_beta'] ?? null;
    }
     ...
     * Sets bank_group
     *
     * @param BankGroup $bank_group <strong>Type:</strong> BankGroup<br/> Bank group
     *
     * @return self
     */
