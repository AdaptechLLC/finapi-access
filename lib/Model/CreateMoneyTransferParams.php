...
class CreateMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['money_transfers'] = $data['money_transfers'] ?? null;
     ...
     * Sets execution_date
     *
     * @param string|null $execution_date Execution date for the money transfer(s), in the format 'YYYY-MM-DD'. May not be in the past. For instant payments, it must be the current date.If not specified, then the current date will be used.
     *
     * @return self
     */
