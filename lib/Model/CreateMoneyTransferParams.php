...
class CreateMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets execution_date
     *
     * @param string|null $execution_date Execution date for the money transfer(s), in the format 'YYYY-MM-DD'. May not be in the past. If not specified, then the current date will be used.
     *
     * @return self
     */
