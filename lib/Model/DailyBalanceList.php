...
class DailyBalanceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['latest_common_balance_timestamp'] = $data['latest_common_balance_timestamp'] ?? null;
        $this->container['daily_balances'] = $data['daily_balances'] ?? null;
     ...
     * Sets paging
     *
     * @param Paging $paging <strong>Type:</strong> Paging<br/> Information for pagination
     *
     * @return self
     */
