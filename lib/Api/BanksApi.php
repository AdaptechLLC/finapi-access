...
class BanksApi
{
    ...
    public function getAndSearchAllBanksRequest($ids = null, $search = null, $supported_interfaces = null, $location = null, $tpp_authentication_group_ids = null, $is_test_bank = null, $page = 1, $per_page = 20, $order = null, $x_request_id = null)
    {
        ...
        if ($supported_interfaces !== null) {
            if('form' === 'form' && is_array($supported_interfaces)) {
                foreach($supported_interfaces as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
        ...
        if ($tpp_authentication_group_ids !== null) {
            if('form' === 'form' && is_array($tpp_authentication_group_ids)) {
                foreach($tpp_authentication_group_ids as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
        ...
        if ($is_test_bank !== null) {
            if('form' === 'form' && is_array($is_test_bank)) {
                foreach($is_test_bank as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['isTestBank'] = $is_test_bank;
            }
        }
        // query params
        if ($page !== null) {
