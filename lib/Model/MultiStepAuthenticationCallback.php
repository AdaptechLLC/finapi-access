...
class MultiStepAuthenticationCallback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['challenge_response'] = $data['challenge_response'] ?? null;
        $this->container['two_step_procedure_id'] = $data['two_step_procedure_id'] ?? null;
        $this->container['redirect_callback'] = $data['redirect_callback'] ?? null;
        $this->container['decoupled_callback'] = $data['decoupled_callback'] ?? null;
    }
