...
class CashFlowList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['cash_flows'] = $data['cash_flows'] ?? null;
        $this->container['total_income'] = $data['total_income'] ?? null;
        $this->container['total_spending'] = $data['total_spending'] ?? null;
