...
class ErrorCode
{
     ...
     */
    const ADDITIONAL_AUTHENTICATION_REQUIRED = 'ADDITIONAL_AUTHENTICATION_REQUIRED';
    const BAD_REQUEST = 'BAD_REQUEST';
    const BANK_SERVER_REJECTION = 'BANK_SERVER_REJECTION';
    const COLLECTIVE_MONEY_TRANSFER_NOT_SUPPORTED = 'COLLECTIVE_MONEY_TRANSFER_NOT_SUPPORTED';
    const ENTITY_EXISTS = 'ENTITY_EXISTS';
    const FORBIDDEN = 'FORBIDDEN';
    const IBAN_ONLY_DIRECT_DEBIT_NOT_SUPPORTED = 'IBAN_ONLY_DIRECT_DEBIT_NOT_SUPPORTED';
    const IBAN_ONLY_MONEY_TRANSFER_NOT_SUPPORTED = 'IBAN_ONLY_MONEY_TRANSFER_NOT_SUPPORTED';
    const ILLEGAL_ENTITY_STATE = 'ILLEGAL_ENTITY_STATE';
    const ILLEGAL_FIELD_VALUE = 'ILLEGAL_FIELD_VALUE';
    const ILLEGAL_PAGE_SIZE = 'ILLEGAL_PAGE_SIZE';
    const INVALID_CONSENT = 'INVALID_CONSENT';
    const INVALID_FILTER_OPTIONS = 'INVALID_FILTER_OPTIONS';
    const INVALID_TOKEN = 'INVALID_TOKEN';
    const INVALID_TWO_STEP_PROCEDURE = 'INVALID_TWO_STEP_PROCEDURE';
    const LOCKED = 'LOCKED';
    const LOGIN_FIELDS_MISMATCH = 'LOGIN_FIELDS_MISMATCH';
    ...
    const MISSING_TWO_STEP_PROCEDURE = 'MISSING_TWO_STEP_PROCEDURE';
    const NO_ACCOUNTS_FOR_TYPE_LIST = 'NO_ACCOUNTS_FOR_TYPE_LIST';
    const NO_CERTIFICATE = 'NO_CERTIFICATE';
    const NO_EXISTING_CHALLENGE = 'NO_EXISTING_CHALLENGE';
    const NO_TPP_CLIENT_CREDENTIALS = 'NO_TPP_CLIENT_CREDENTIALS';
    const NO_PSU_METADATA = 'NO_PSU_METADATA';
    const TOO_MANY_IDS = 'TOO_MANY_IDS';
    const UNAUTHORIZED_ACCESS = 'UNAUTHORIZED_ACCESS';
    const UNEXPECTED_ERROR = 'UNEXPECTED_ERROR';
    const UNKNOWN_ENTITY = 'UNKNOWN_ENTITY';
    const UNSUPPORTED_BANK = 'UNSUPPORTED_BANK';
    ...
    const WEB_FORM_ABORTED = 'WEB_FORM_ABORTED';
