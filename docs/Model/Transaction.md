...
**parent_id** | **int** | Parent transaction identifier |
...
**currency** | [**Currency**](Currency.md) | &lt;strong&gt;Type:&lt;/strong&gt; Currency&lt;br/&gt; Transaction currency in ISO 4217 format.This field can be null if not explicitly provided the bank. In this case it can be assumed as account’s currency. |
**purpose** | **string** | Transaction purpose. Maximum length: 2000 |
**counterpart_name** | **string** | Counterpart name. Maximum length: 80 |
**counterpart_account_number** | **string** | Counterpart account number |
**counterpart_iban** | **string** | Counterpart IBAN |
**counterpart_blz** | **string** | Counterpart BLZ |
**counterpart_bic** | **string** | Counterpart BIC |
**counterpart_bank_name** | **string** | Counterpart Bank name |
**counterpart_mandate_reference** | **string** | The mandate reference of the counterpart |
**counterpart_customer_reference** | **string** | The customer reference of the counterpart |
**counterpart_creditor_id** | **string** | The creditor ID of the counterpart. Exists only for SEPA direct debit transactions (\&quot;Lastschrift\&quot;). |
**counterpart_debitor_id** | **string** | The originator&#39;s identification code. Exists only for SEPA money transfer transactions (\&quot;Überweisung\&quot;). |
**type** | **string** | Transaction type, according to the bank. If set, this will contain a German term that you can display to the user. Some examples of common values are: \&quot;Lastschrift\&quot;, \&quot;Auslands&amp;uuml;berweisung\&quot;, \&quot;Geb&amp;uuml;hren\&quot;, \&quot;Zinsen\&quot;. The maximum possible length of this field is 255 characters. |
