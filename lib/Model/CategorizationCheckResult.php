...
class CategorizationCheckResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets category
     *
     * @param Category $category <strong>Type:</strong> Category<br/> A category. The determined transaction category for the given transactionId. This can be null, if the categorization algorithm fails to find a matching rule.
     *
     * @return self
     */
