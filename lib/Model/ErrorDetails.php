...
class ErrorDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'ErrorCode',
        'type' => 'ErrorType',
        'multi_step_authentication' => 'MultiStepAuthenticationChallenge'
    ];
     ...
     *
     * @return MultiStepAuthenticationChallenge
     */
     ...
     *
     * @param MultiStepAuthenticationChallenge $multi_step_authentication <strong>Type:</strong> MultiStepAuthenticationChallenge<br/> This field is set when a multi-step authentication is required, i.e. when you need to repeat the original service call and provide additional data. The field contains information about what additional data is required.
     *
     * @return self
     */
