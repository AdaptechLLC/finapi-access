...
class NotificationRulesApi
{
    ...
    public function getAndSearchAllNotificationRulesRequest($ids = null, $trigger_event = null, $include_details = null, $x_request_id = null)
    {
        ...
        if ($trigger_event !== null) {
            if('form' === 'form' && is_array($trigger_event)) {
                foreach($trigger_event as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['triggerEvent'] = $trigger_event;
            }
        }
        // query params
        if ($include_details !== null) {
            if('form' === 'form' && is_array($include_details)) {
                foreach($include_details as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
