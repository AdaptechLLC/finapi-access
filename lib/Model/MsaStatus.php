...
class MsaStatus
{
     ...
     */
    const CHALLENGE_RESPONSE_REQUIRED = 'CHALLENGE_RESPONSE_REQUIRED';
    const TWO_STEP_PROCEDURE_REQUIRED = 'TWO_STEP_PROCEDURE_REQUIRED';
    const REDIRECT_REQUIRED = 'REDIRECT_REQUIRED';
    const DECOUPLED_AUTH_REQUIRED = 'DECOUPLED_AUTH_REQUIRED';
    const DECOUPLED_AUTH_IN_PROGRESS = 'DECOUPLED_AUTH_IN_PROGRESS';
