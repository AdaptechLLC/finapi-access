...
class MonthlyUserStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['min_bank_connection_count'] = $data['min_bank_connection_count'] ?? null;
        $this->container['max_bank_connection_count'] = $data['max_bank_connection_count'] ?? null;
    }
