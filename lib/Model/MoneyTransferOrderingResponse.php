...
class MoneyTransferOrderingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['success_message'] = $data['success_message'] ?? null;
        $this->container['warn_message'] = $data['warn_message'] ?? null;
        ...
        $this->container['tan_list_number'] = $data['tan_list_number'] ?? null;
     ...
     * Sets optical_data
     *
     * @param string $optical_data In case that the bank server has instructed the user to scan a flicker code, then this field will contain the raw data for the flicker animation as a BASE-64 string. Otherwise, this field will be not set (i.e. null). For more information on how to process the flicker code data, please refer to <a href='https://documentation.finapi.io/access/Flicker-Code-Template.2807824454.html' target='_blank'>this</a> article.
     *
     * @return self
     */
